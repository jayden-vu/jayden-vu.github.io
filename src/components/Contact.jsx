...
import { FiCheck, FiClock, FiCode, FiCopy, FiDownload, FiExternalLink, FiGithub, FiLinkedin, FiMail, FiMapPin, FiMessageCircle, FiMonitor, FiPhone, FiUser } from 'react-icons/fi';
...
const ContactSection = () => {
  ...
  const handleResumeDownload = () => {
    ...
    const resumePath = `${import.meta.env.BASE_URL}/resume/jayden_vu_resume.pdf`;
    const link = document.createElement('a');
    link.href = resumePath;
    link.download = 'jayden_vu_resume.pdf';
  ...
  const contactInfo = {
    email: 'jayden.vu.work@gmail.com',
    phone: '+84-964076083',
    location: 'Hanoi, Vietnam',
    timezone: 'GMT +7:00',
    linkedin: 'https://www.linkedin.com/in/jayden-vu/',
    github: 'https://github.com/jayden-vu',
    status: 'Available for work',
    workType: 'Remote/Hybrid OK',
  };

  return (
    <section id="contact" className="relative bg-black text-white py-20 px-6 md:px-12 lg:px-20 w-full overflow-hidden" style={{ fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
      ...
      <div className="relative z-10">
        {/* Header */}
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.3 }} transition={{ duration: 0.8, ease: 'easeOut' }} className="text-center mb-16">
          ...
          <p className="text-white/70 max-w-2xl mx-auto text-lg">Ready to bring your ideas to life? Let's build something amazing together!</p>
        </motion.div>
        ...
        <motion.div
          ...
          <motion.div
            ...
            {/* Top Row */}
            <motion.div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: false }} transition={{ duration: 0.6, delay: 0.5 }}>
              {/* Quick Connect */}
              <motion.div className="space-y-4" initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: false }} transition={{ duration: 0.6, delay: 0.6 }}>
                ...
                <div className="space-y-3">
                  <motion.div
                    ...
                    {copied === 'email' ? <FiCheck className="text-emerald-400 ml-auto group-hover:scale-110 transition-transform" /> : <FiCopy className="text-white/50 ml-auto group-hover:text-white/80 transition-colors" />}
                  </motion.div>
                  <motion.div
                    className="group flex items-center gap-3 p-4 rounded-xl border border-white/20 hover:border-white/30 transition-all duration-300 cursor-pointer"
                    style={{
                    ...
                    {copied === 'phone' ? <FiCheck className="text-emerald-400 ml-auto group-hover:scale-110 transition-transform" /> : <FiCopy className="text-white/50 ml-auto group-hover:text-white/80 transition-colors" />}
                  </motion.div>
                </div>
              </motion.div>

              {/* Location */}
              <motion.div className="space-y-4" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false }} transition={{ duration: 0.6, delay: 0.7 }}>
              ...
              {/* Status */}
              <motion.div className="space-y-4" initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: false }} transition={{ duration: 0.6, delay: 0.8 }}>
            ...
            {/* Bottom Row */}
            <motion.div className="grid grid-cols-1 lg:grid-cols-3 gap-6" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: false }} transition={{ duration: 0.6, delay: 0.9 }}>
              {/* Social Links */}
              <motion.div className="space-y-4" initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: false }} transition={{ duration: 0.6, delay: 1 }}>
              ...
              {/* Resources */}
              <motion.div className="space-y-4" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false }} transition={{ duration: 0.6, delay: 1.1 }}>
                ...
                <div className="space-y-3">
                  <motion.button
                    ...
                    <span className="text-white/90 text-sm font-medium">{'→ jayden_vu_resume.pdf'}</span>
              ...
              {/* Let's Talk */}
              <motion.div className="space-y-4" initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: false }} transition={{ duration: 0.6, delay: 1.2 }}>
                ...
                <div
                  ...
                  <p className="text-white/90 text-sm leading-relaxed mb-4">Ready to collaborate on your next project!</p>
                  <motion.button
