export default function GradientText({
  ...
  return (
    <>
      ...
      <div className={`relative inline-block rounded-[1.25rem] font-medium overflow-hidden cursor-pointer ${className}`} style={{ fontFamily: 'Inter, sans-serif' }}>
        {showBorder && (
          <div className="absolute inset-0 z-0 pointer-events-none" style={gradientStyle}>
            <div
