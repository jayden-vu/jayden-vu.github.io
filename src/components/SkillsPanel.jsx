      ...
      <div
        ...
        <div className="relative z-10 p-4 sm:p-6 h-full flex flex-col">
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="text-2xl sm:text-3xl" style={{ color: `${color}` }}>
              {icon}
            </div>
            <div className="min-w-0 flex-1">
              <h3 className="text-base sm:text-lg font-bold leading-tight" style={{ color: color }}>
                {title}
              </h3>
              <div className="text-xs text-white/60 mt-1">{skills.length} Technologies</div>
            </div>
            {/* Skills count badge */}
            <div
          ...
          <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
            <div className="text-sm text-white/80 font-medium mb-3">Technology Stack:</div>
  ...
  return (
    <motion.div
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <motion.div className="flex-1 flex flex-col items-center justify-center p-6 group-hover:opacity-0" transition={{ duration: 0.3, ease: 'easeOut' }}>
          {/* Icon */}
          <motion.div className="text-4xl sm:text-5xl md:text-6xl mb-4" style={{ color: `${color}` }} whileHover={{ scale: 1.1 }} transition={{ duration: 0.2 }}>
            {icon}
          </motion.div>

          {/* Title */}
          <h3 className="text-lg sm:text-xl font-bold text-center mb-3 leading-tight px-2" style={{ color: color }}>
            {title}
          </h3>

          {/* Skills count and preview */}
          <div className="text-center">
            <div className="text-sm text-white/70 mb-2 font-medium">{skills.length} Technologies</div>

            {/* Quick preview of top skills */}
            <div className="text-xs text-white/50 line-clamp-2 px-2">{skills.slice(0, 3).join(' • ')}</div>
          </div>
        ...
        <motion.div
          ...
          <div className="flex-1 min-h-50">
            <div className="text-sm text-white/80 font-medium mb-3 sm:mb-4">Technology Stack:</div>
